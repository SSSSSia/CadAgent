...
PROVIDER_PRESETS = [
    {"name": "SiliconFlow (GLM-5.1)", "url": "https://api.siliconflow.cn/v1",
     "model": "Pro/zai-org/GLM-5.1"},
    {"name": "SiliconFlow (DeepSeek)", "url": "https://api.siliconflow.cn/v1",
     "model": "deepseek-ai/DeepSeek-V3"},
    {"name": "OpenAI (GPT-4o)", "url": "https://api.openai.com/v1",
     "model": "gpt-4o"},
    {"name": "DeepSeek", "url": "https://api.deepseek.com/v1",
     "model": "deepseek-chat"},
    {"name": "ZhipuAI (GLM-4)", "url": "https://open.bigmodel.cn/api/paas/v4",
     "model": "glm-4-plus"},
